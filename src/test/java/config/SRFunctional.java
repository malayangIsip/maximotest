...
public class SRFunctional extends TestAutomation {
    static String testCase = "";	
    static String testName = "SRFunctional";
    ...
    @Test
    public void createSRpriority1User155() {
    	testCase = "createSRpriority1User155";
		...
		try{  
			...
			action.assertValue("txtbx_Source", "155");
	    	...
	    	Log.error("Exception createSRpriority1User155--- " + e.getMessage());
